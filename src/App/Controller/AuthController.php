...
class AuthController extends BaseController
{
    ...
    public function getAccessTokenAction(Request $request, Response $response): string
    {
        $input = $this->getRequestInputAsArray($request);
        ...
        try {
            ...
            return $this->jsonResponse(['token' => $accessToken], 200, $response);
        } catch (InvalidArgumentException $exception) {
            return '{$accessToken} does not meet the needed elements';
        }
    }
}
